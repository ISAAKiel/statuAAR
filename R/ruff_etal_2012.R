...
#######################################################
# Funktionen nach Geschlecht und SEE desc
# North & All
stature.i <- (Fem+Tib * 1.49) + 435.3
stature.i <- (Femur * 2.77) + 405
stature.i <- (Tibia * 3.13) + 501.1
stature.i <- (Humerus * 3.72) + 448.6
stature.i <- (Radius * 4.46) + 569.4
stature.f <- (Fem+Tib * 1.42) + 485.9
stature.f <- (Femur * 2.69) + 435.6
stature.f <- (Tibia * 2.92) + 569.4
stature.f <- (Humerus * 3.38) + 546
stature.f <- (Radius * 4.2) + 630.8
stature.m <- (Fem+Tib * 1.49) + 435.5
stature.m <- (Femur * 2.72) + 428.5
stature.m <- (Tibia * 3.09) + 520.4
stature.m <- (Humerus * 3.83) + 414.2
stature.m <- (Radius * 4.85) + 474.6

# South & All
stature.i <- (Fem+Tib * 1.48) + 430
stature.i <- (Femur * 2.77) + 405
stature.i <- (Tibia * 3.02) + 513.6
stature.i <- (Humerus * 3.72) + 448.6
stature.i <- (Radius * 4.46) + 569.4
stature.f <- (Fem+Tib * 1.47) + 429.6
stature.f <- (Tibia * 3.05) + 496.8
stature.f <- (Femur * 2.69) + 435.6
stature.f <- (Humerus * 3.38) + 546
stature.f <- (Radius * 4.2) + 630.8
stature.m <- (Fem+Tib * 1.4) + 496.8
stature.m <- (Tibia * 2.78) + 607.6
stature.m <- (Femur * 2.72) + 428.5
stature.m <- (Humerus * 3.83) + 414.2
stature.m <- (Radius * 4.85) + 474.6
