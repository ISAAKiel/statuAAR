...
#' formulas for women is used for all individuals. In addition, the hierarchical
#' order is given for the least-square linear regression, allthough regressions
