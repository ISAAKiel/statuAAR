#' @name vercellotti_etal_2009
#'
#' @title Calculate stature estimation according to: Vercellotti et al. 2009
#'
#' @description
...
#' Vercellotti et al. propose regression calculations for the combination of male and female
